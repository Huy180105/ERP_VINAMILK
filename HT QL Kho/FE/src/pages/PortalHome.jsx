...
export default function PortalHome() {
  ...
  const erpModules = [
    ...
    },
    {
      ...
      desc: 'Lập Lệnh sản xuất, Quản lý công đoạn (Tiệt trùng, Đồng hóa), Bán thành phẩm & Nghiệm thu QC.',
      icon: Factory,
      ...
      stats: '14 Bảng CSDL | 42 Chức Năng'
    },
    {
      id: 'hr',
          ...
          <div className="lg:col-span-8 space-y-5">
            ...
            <div className="pt-2 flex flex-wrap gap-4 text-xs font-bold">
              <button 
                ...
                className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white px-6 py-3.5 rounded-2xl shadow-lg shadow-amber-500/20 transform transition hover:-translate-y-0.5 flex items-center space-x-2"
              >

...
export default function Reports() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-3 bg-white p-4 rounded-md border border-slate-200 shadow-sm text-xs">
              ...
              {loading ? (
                ...
                summary.map((row, idx) => (
                  <tr key={idx} className="hover:bg-slate-50 transition">
                    <td className="p-3 font-mono font-bold text-[#0B2341]">{row.maTonKho}</td>
                    ...
                    <td className="p-3 text-right font-semibold text-[#0B2341]">{row.tonKhoHienTai?.toLocaleString()}</td>

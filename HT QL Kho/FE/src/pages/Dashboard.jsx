    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-lg border border-slate-200/80  transform transition hover:-translate-y-1 flex items-center justify-between">
          ...
          <div className="p-3.5 bg-blue-50 text-[#0B2341] rounded-lg">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg border border-slate-200/80  p-6 space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            ...
            <span className="text-xs font-semibold bg-amber-100 text-amber-900 px-3 py-1 rounded-full border border-amber-200">
        ...
        <div className="bg-white rounded-lg border border-slate-200/80  p-6 space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            ...
            <span className="text-xs font-semibold bg-rose-100 text-rose-900 px-3 py-1 rounded-full border border-rose-200">

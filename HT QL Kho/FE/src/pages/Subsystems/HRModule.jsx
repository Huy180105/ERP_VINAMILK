...
export default function HRModule() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] p-8 space-y-6">
      ...
      <div className="bg-gradient-to-r from-teal-700 to-emerald-800 text-white rounded-lg p-8  space-y-3">
        <div className="p-3 bg-white/10 rounded-lg w-fit ">
          <Users className="w-8 h-8 text-emerald-300" />
        </div>
        <h1 className="text-2xl font-bold">Phân Hệ Quản Lý Nhân Sự (HRM & Payroll)</h1>
      ...
      <div className="bg-white rounded-lg p-6 border border-slate-200/80 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
          <div className="p-3 bg-slate-50 rounded-lg border font-mono"><b>PhongBan</b>: Phòng ban trực thuộc</div>
          <div className="p-3 bg-slate-50 rounded-lg border font-mono"><b>ChucVu</b>: Chức vụ & phụ cấp</div>
          <div className="p-3 bg-slate-50 rounded-lg border font-mono"><b>NhanVien</b>: Hồ sơ nhân viên gốc</div>
          <div className="p-3 bg-slate-50 rounded-lg border font-mono"><b>HopDong</b>: Hợp đồng lao động</div>
          <div className="p-3 bg-slate-50 rounded-lg border font-mono"><b>BangCong</b>: Chấm công hàng tháng</div>
          <div className="p-3 bg-slate-50 rounded-lg border font-mono"><b>BangLuong</b>: Tổng hợp lương tháng</div>
        </div>
      </div>
    </div>
  );

...
export default function FinanceModule() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] p-8 space-y-6">
      ...
      <div className="bg-gradient-to-r from-purple-700 to-pink-800 text-white rounded-lg p-8  space-y-3">
        <div className="p-3 bg-white/10 rounded-lg w-fit ">
          <Wallet className="w-8 h-8 text-pink-200" />
        </div>
        <h1 className="text-2xl font-bold">Phân Hệ Quản Lý Thu Chi (Finance & Cash/Bank)</h1>
      ...
      <div className="bg-white rounded-lg p-6 border border-slate-200/80 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs font-mono">
          <div className="p-3 bg-slate-50 rounded-lg border"><b>DanhMucThu</b>: Khoản mục thu</div>
          <div className="p-3 bg-slate-50 rounded-lg border"><b>DanhMucChi</b>: Khoản mục chi</div>
          <div className="p-3 bg-slate-50 rounded-lg border"><b>DoiTuongGiaoDich</b>: Ánh xạ đối tượng giao dịch</div>
          <div className="p-3 bg-slate-50 rounded-lg border"><b>TaiKhoanQuy</b>: Quỹ tiền mặt/Ngân hàng</div>
          <div className="p-3 bg-slate-50 rounded-lg border"><b>PhieuThu</b> & <b>PhieuChi</b>: Phiếu thu/chi tiền</div>
          <div className="p-3 bg-slate-50 rounded-lg border"><b>BaoCaoThuChi</b>: Báo cáo dòng tiền</div>
        </div>
      </div>
    </div>
  );

            ...
            <form onSubmit={handleSave} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs font-bold text-slate-800 disabled:opacity-60 outline-none focus:ring-2 focus:ring-[#002795]"
                  required
                />
              </div>

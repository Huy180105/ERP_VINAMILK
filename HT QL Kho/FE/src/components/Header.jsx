...
export default function Header() {
  return (
    <header className="bg-gradient-to-r from-[#0B2341] via-[#0B2341] to-[#001458] text-white  px-6 py-3.5 flex items-center justify-between sticky top-0 z-30 border-b border-blue-800/40">
      {/* Brand & Logo */}
      ...
      <div className="flex items-center space-x-4">
        <div className="hidden sm:flex items-center space-x-2 bg-emerald-500/15 border border-emerald-400/30 px-3.5 py-1.5 rounded-full text-emerald-300 text-xs font-semibold ">
        ...
        <button className="relative p-2 rounded-full hover:bg-white/10 text-blue-200 transition-all">
          ...
          <span className="absolute top-1 right-1 w-2.5 h-2.5 bg-amber-400 rounded-full ring-2 ring-[#0B2341] animate-ping"></span>
          <span className="absolute top-1 right-1 w-2.5 h-2.5 bg-amber-400 rounded-full ring-2 ring-[#0B2341]"></span>
        </button>

        <div className="flex items-center space-x-3 border-l border-blue-400/30 pl-4">
          <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-blue-600 to-indigo-500 border-2 border-white/60 flex items-center justify-center font-bold text-sm text-white shadow-sm">
            TK
          </div>
